...
var sortReport=async function(req,res){
    ...
    const monthEnum = {"january":1, "feburary":2, "march":3, "april":4,"may":5,"june":6,
    "july":7,
    "august":8,
    "september":9,
    "october":10,
    ...
    unirest.get(APIKEY).then((response) => {
     ...
     if(fkey==undefined&&skey==undefined){
         unordered.sort((a,b)=>Number(a.amount)<Number(b.amount)?1:-1)
